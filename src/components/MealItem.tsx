...
type mealItemProps = { title: string; imageUrl: string; duration: number; complexity: string; affordability: string };

function MealItem(props: mealItemProps) {
    return (
        <View style={styles.mealItem}>
            <Pressable android_ripple={{ color: "gray" }} style={({ pressed }) => (pressed ? styles.buttonPressed : null)}>
